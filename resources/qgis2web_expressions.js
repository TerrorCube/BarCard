...
function exp_Survey_1rule0_eval_expression(context) {
    // Bewertung = 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Bewertung')  == 0);
    } else {
        return (feature.get('Bewertung')  == 0);
    }
}
...
function exp_Survey_1rule1_eval_expression(context) {
    // Bewertung = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Bewertung')  == 1);
    } else {
        return (feature.get('Bewertung')  == 1);
    }
}
...
function exp_Survey_1rule2_eval_expression(context) {
    // Bewertung = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Bewertung')  == 2);
    } else {
        return (feature.get('Bewertung')  == 2);
    }
}
...
function exp_Survey_1rule3_eval_expression(context) {
    // Bewertung = 3

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Bewertung')  == 3);
    } else {
        return (feature.get('Bewertung')  == 3);
    }
}
...
function exp_Survey_1rule4_eval_expression(context) {
    // Bewertung = 4

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Bewertung')  == 4);
    } else {
        return (feature.get('Bewertung')  == 4);
    }
}
...
function exp_Survey_1rule5_eval_expression(context) {
    // Bewertung = 5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Bewertung')  == 5);
    } else {
        return (feature.get('Bewertung')  == 5);
    }
}
...
function exp_Survey_1rule6_eval_expression(context) {
    // Art = 'Bar'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Art')  == 'Bar');
    } else {
        return (feature.get('Art')  == 'Bar');
    }
}
...
function exp_Survey_1rule7_eval_expression(context) {
    // Art = 'Späti'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Art')  == 'Späti');
    } else {
        return (feature.get('Art')  == 'Späti');
    }
}